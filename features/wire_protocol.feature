...
Feature: Wire Protocol
  ...
  Scenario: Dry run finds no step match
    Given there is a wire server running on port 98989 which understands the following protocol:
      | request                                                                 | response                             |
      | {"message":"step_matches","params":{"name_to_match":"we're all wired"}} | {"message":"step_match","params":[]} |
  ...
  Scenario: Dry run finds a step match
    Given there is a wire server running on port 98989 which understands the following protocol:
      | request                                                                 | response                                                  |
      | {"message":"step_matches","params":{"name_to_match":"we're all wired"}} | {"message":"step_match","params":[{"id":"1", "args":[]}]} |
    When I run cucumber --dry-run -f progress features
    And it should pass with
      """
      -
  ...
  Scenario: Invoke a step definition which passes
    Given there is a wire server running on port 98989 which understands the following protocol:
      | request                                                                 | response                                                  |
      | {"message":"step_matches","params":{"name_to_match":"we're all wired"}} | {"message":"step_match","params":[{"id":"1", "args":[]}]} |
      | {"message":"invoke","params":{"id":"1","args":[]}}                      | {"message":"success","params":null}                       |
  ...
  Scenario: Invoke a step definition which fails
    Given there is a wire server running on port 98989 which understands the following protocol:
      | request                                                                 | response                                                            |
      | {"message":"step_matches","params":{"name_to_match":"we're all wired"}} | {"message":"step_match","params":[{"id":"1", "args":[]}]}           |
      | {"message":"invoke","params":{"id":"1","args":[]}}                      | {"message":"step_failed","params":{"message":"The wires are down"}} |
    When I run cucumber -f progress features
  ...
  Scenario: Invoke a step definition which takes arguments (and passes)
    Given there is a wire server running on port 98989 which understands the following protocol:
      | request                                                                 | response                                                                           |
      | {"message":"step_matches","params":{"name_to_match":"we're all wired"}} | {"message":"step_match","params":[{"id":"1", "args":[{"val":"wired", "pos":10}]}]} |
      | {"message":"invoke","params":{"id":"1","args":["wired"]}}               | {"message":"success","params":null}                                                |
