...
Feature: JUnit output formatter
  ...
  Scenario: one feature, one passing scenario, one failing scenario
    ...
    And the junit output file "tmp/TEST-features-one_passing_one_failing.xml" should contain:
      ...
      <testsuite errors="0" failures="1" name="One passing scenario, one failing scenario" skipped="0" tests="2" time="">
      <testcase classname="One passing scenario, one failing scenario" name="Passing" time="">
        <system-out/>
        <system-err/>
      </testcase>
      <testcase classname="One passing scenario, one failing scenario" name="Failing" time="">
  ...
  Scenario: one feature in a subdirectory, one passing scenario, one failing scenario
    ...
    And the junit output file "tmp/TEST-features-some_subdirectory-one_passing_one_failing.xml" should contain:
      """
      <?xml version="1.0" encoding="UTF-8"?>
      <testsuite errors="0" failures="1" name="Subdirectory - One passing scenario, one failing scenario" skipped="0" tests="2" time="">
      <testcase classname="Subdirectory - One passing scenario, one failing scenario" name="Passing" time="">
        <system-out/>
        <system-err/>
      </testcase>
      <testcase classname="Subdirectory - One passing scenario, one failing scenario" name="Failing" time="">
        <failure message="failed Failing" type="failed">
          <![CDATA[Scenario: Failing
  ...
  Scenario: pending and undefined steps are reported as skipped
    ...
    And the junit output file "tmp/TEST-features-pending.xml" should contain:
      """
      <?xml version="1.0" encoding="UTF-8"?>
      <testsuite errors="0" failures="0" name="Pending step" skipped="2" tests="2" time="">
      <testcase classname="Pending step" name="Pending" time="">
        <skipped/>
        <system-out/>
        <system-err/>
      </testcase>
      <testcase classname="Pending step" name="Undefined" time="">
        <skipped/>
        <system-out/>
        <system-err/>
      </testcase>
  ...
  Scenario: pending and undefined steps with strict option should fail
    ...
    And the junit output file "tmp/TEST-features-pending.xml" should contain:
      """
      <?xml version="1.0" encoding="UTF-8"?>
      <testsuite errors="0" failures="2" name="Pending step" skipped="0" tests="2" time="">
      <testcase classname="Pending step" name="Pending" time="">
...
You *must* specify --out DIR for the junit formatter
  ...
  Scenario: one feature, one scenario outline, two examples: one passing, one failing
    ...
    And the junit output file "tmp/TEST-features-scenario_outline.xml" should contain:
      """
      <?xml version="1.0" encoding="UTF-8"?>
      <testsuite errors="0" failures="1" name="Scenario outlines" skipped="0" tests="2" time="">
      <testcase classname="Scenario outlines" name="Using scenario outlines (outline example : | passing |)" time="">
        <system-out/>
        <system-err/>
      </testcase>
      <testcase classname="Scenario outlines" name="Using scenario outlines (outline example : | failing |)" time="">
