Gem::Specification.new do |s|
  ...
  s.add_dependency 'cucumber-core', '~> 9.0', '>= 9.0.0'
  ...
  s.add_dependency 'cucumber-wire', '~> 5.0', '>= 5.0.0'
  ...
  s.add_development_dependency 'nokogiri', '~> 1.11', '>= 1.11.3'
  ...
  s.add_development_dependency 'test-unit', '~> 3.4', '>= 3.4.0'
  s.add_development_dependency 'webrick', '~> 1.7', '>= 1.7.0'

  # For maintainer scripts
  s.add_development_dependency 'octokit', '~> 4.20', '>= 4.20.0'
