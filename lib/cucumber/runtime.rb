...
module Cucumber
  class Runtime
    ...
    def run!
      ...
      receiver = Test::Runner.new(@configuration.event_bus, @configuration.id_generator, Cucumber::Formatter::BacktraceFilter, @configuration.retry_attempts, @configuration.retry_total_tests)
    ...
    def filters
      ...
      [].tap do |filters|
        ...
        filters << Filters::Reverser.new if @configuration.reverse_order?
