  ...
  class Runtime
    class SupportCode
      ...
      def find_after_step_hooks(test_case)
        ...
        StepHooks.new(hooks, @configuration.id_generator)
      end
      ...
      def apply_before_hooks(test_case)
        ...
        BeforeHooks.new(hooks, scenario, @configuration.id_generator).apply_to(test_case)
      end
      ...
      def apply_after_hooks(test_case)
        ...
        AfterHooks.new(hooks, scenario, @configuration.id_generator).apply_to(test_case)
      end
