...
spec/cucumber/step_mother_spec.rb:\\d+:in `/Three (.*) mice/'
spec/cucumber/step_mother_spec.rb:\\d+:in `/Three blind (.*)/'
...
spec/cucumber/step_mother_spec.rb:\\d+:in `/Three (.*) mice/'
spec/cucumber/step_mother_spec.rb:\\d+:in `/Three cute (.*)/'
    ...
    describe "Handling the World" do
      ...
      it "should raise an error if the world is nil" do
        ...
        begin
          ...
          e.backtrace[0].should =~ /spec\/cucumber\/step_mother_spec\.rb\:\d+\:in `World'/
        end
      end
