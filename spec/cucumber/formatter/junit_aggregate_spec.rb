...
require 'cucumber/formatter/junit_aggregate'
require 'nokogiri'

module Cucumber::Formatter
  describe JunitAggregate do
    ...
    class TestDoubleJunitAggegateFormatter < JunitAggregate
      ...
      def write_report feature_filename, testsuie
        @written_files ||= {}
        @written_files[feature_filename] = testsuie.build_document
      end
    end
    
    before(:each) do
      File.stub!(:directory?).and_return(true)
      @formatter = TestDoubleJunitAggegateFormatter.new(step_mother, '', {})
    end
