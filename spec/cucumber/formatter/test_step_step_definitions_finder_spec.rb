...
require 'cucumber/formatter/test_step_step_definitions_finder'

module Cucumber
  module Formatter
    describe TestStepStepDefinitionsFinder do
      ...
      before(:each) do
        ...
        @formatter = TestStepStepDefinitionsFinder.new(@config)
